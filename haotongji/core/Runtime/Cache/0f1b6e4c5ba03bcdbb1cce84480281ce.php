	...
	<div class="headerMiddle">
		...
		<div class="headerBottomContent">
			<ul class="headerNavContent">
				...
				<li class="borderLi"></li>	
					<li info="alarm" class="navLi"><a title="<?php echo ($cfg_sitetitle); ?>购买源码" class="navLiA" href="http://www.73ym.com">源码下载</a></li>
					<li class="borderLi"></li>
			</ul>
...
<div style="background-color:#005EAC;height:352px;" id="top2">
 <div style="margin:auto;width:960px;height:352px;" id="topface">
  ...
  <!--右侧登录框结束-->
  <div id="rreg"><a title="立即注册" href="/index.php/Index/reg.html">立即注册</a></div>  
  <?php else: ?>
   <div id="iright">
     <div id="userlogin">
...
<!--/about-->
	...
	<!--底部会员信息-->
	<ul class="serverTipInfo">
		<li><span>友情连接：73源码网 www.73ym.com</span>&nbsp;&nbsp;
...
<div class="footer" id="footer">
    ﻿&copy; 2014 73ym.com 版权所有 ICP备:粤ICP备13003173号-1 73源码网 www.73ym.com 提供源码
