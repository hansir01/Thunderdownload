	...
	<div class="headerMiddle">
		...
		<div class="headerBottomContent">
			<ul class="headerNavContent">
				...
				<li class="borderLi"></li>	
					<!--li info="alarm" class="navLi"><a title="<?php echo ($cfg_sitetitle); ?>在线充值" class="navLiA" href="/index.php/Pay">在线充值</a></li-->
					<li class="borderLi"></li>
			</ul>
...
﻿<div class="footer" id="footer">
    &copy; 2014 www.hao-tongji.com 版权所有 ICP备:粤ICP备13003173号-1 <script type='text/javascript' src='http://www.hao-tongji.com/index.php/Tj/index?jsuid=134'></script><br />
