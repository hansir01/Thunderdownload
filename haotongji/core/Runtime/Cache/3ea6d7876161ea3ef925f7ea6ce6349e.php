...
<meta name="description" content="<?php echo ($cfg_title); ?> - 访客信息统计系统" />
<title><?php echo ($cfg_title); ?>_<?php echo ($cfg_seotitle); ?></title>
...
<div id="flow_detail_report" class="report_data">
	<div class="report_title">
		...
		<ul id="flow_detail_report_title">
			...
			<li><a href="<?php echo U("User/mailaddtpl");?>" class="leftNav">添加内容模板</a></li>
		</ul>
		</form>
	</div>
	...
	<table id="flow_detail_pv_table" class="report" style="display: table;">
		<tbody><tr class="title reportTableTitle" style="width: 1031px; margin-top: 0px; position: static; top: 0px; border-bottom: medium none;">
			<td class="time" style="width: 100px;">编号</td>
			<td style="width: 160px;">标题</td>
			<td style="width: 110px;">添加时间</td>
		...
		<td style="text-align: left;">
					...
					<td>
						<div style="width:180px; text-align:left; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                           <a href="<?php echo U("User/mailaddtpl",array('id'=>$vo[id]));?>">编辑</a>
						    <a href="<?php echo U("User/maildeltpl",array('id'=>$vo[id]));?>">删除</a>
						   </div>
					</td> 
