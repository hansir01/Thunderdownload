	...
	<div class="headerMiddle">
		...
		<div class="headerBottomContent">
			<ul class="headerNavContent">
				...
				<li class="borderLi"></li>	
					<li info="alarm" class="navLi"><a title="<?php echo ($cfg_sitetitle); ?>购买源码" class="navLiA" href="#">购买源码</a></li>
					<li class="borderLi"></li>
			</ul>
...
<div class="footer" id="footer">
    ﻿&copy; 2014 www.hao-tongji.com 版权所有 ICP备:粤ICP备13003173号-1 商业源码网www.zzcodes.net提供源码
